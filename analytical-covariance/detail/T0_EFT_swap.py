...
def InitParameters(arr):
    global b1,be,g2,b2, b1EFT, b2EFT, b3EFT, b4EFT, b5EFT, a2, a5, a7
    [b1,be,g2,b2, b1EFT, b2EFT, b3EFT, b4EFT, b5EFT, a2, a5, a7]=arr
...
def ez3(k1,k2):
    if(l1==0 and l2==0):
        if(k1!=k2):
            return(-(4*k1*k2*(1155*b1EFT*be**4*k1**14 + 70*be**2*(-66*b3EFT*(7 + 3*be) + 11*b1EFT*(252 + be*(162 + 23*be)) + 
                9*b1EFT**2*be*(198 + be*(132 + 25*be)))*k1**12*k2**2 + 
             7*(220*b3EFT*(-315 + be*(-315 - 70*be + 6*be**2)) + 33*b1EFT*(9450 + be*(10500 + be*(4060 + 3*be*(240 + 37*be)))) + 
                60*b1EFT**2*be*(3465 + 2*be*(2772 + be*(1683 + 2*be*(297 + 50*be)))))*k1**10*k2**4 + 
             2*k1**8*(80850*(7916*a7 + 120*b1EFT - 553*b3EFT + 252*b5EFT) + 
                be*(80850*(7916*a7 - 553*b3EFT + b1EFT*(119 + 60*b1EFT - 84*b2EFT - 84*b4EFT) + 252*b5EFT) + 
                  3234*(86004*a7 - 6025*b3EFT + b1EFT*(1333 + 1880*b1EFT - 2660*b2EFT - 2660*b4EFT) + 2660*b5EFT)*be + 
                   462*(99692*a7 - 7015*b3EFT + 3*b1EFT*(491 + 1989*b1EFT - 2940*b2EFT - 2940*b4EFT) + 2940*b5EFT)*be**2 + 
                   11*b1EFT*(-2845 + 37884*b1EFT - 74088*b2EFT - 74088*b4EFT)*be**3 - 56175*b1EFT**2*be**4) + 
                11088*a2*(2975 + be*(2975 + be*(1281 + 209*be))) - 3696*a5*(28875 + be*(28875 + be*(12341 + 1989*be))) + 
                258720*a7*(35 + be*(35 + be*(21 + 5*be)))*k1**2)*k2**6 + 
             k1**6*(71148*b3EFT*(5 + be)*(5 + be*(4 + be)) + 3696*b1EFT**3*be**2*(35 + 3*be*(14 + 5*be))**2 + 
                12*b1EFT**2*be*(256025 + be*(970200 + be*(1086393 + 501886*be + 89370*be**2))) + 
                11*b1EFT*(418950 + be*(720300 + be*(669144 + be*(290556 + 50797*be)))) + 9856*a7*(735 + be*(735 + be*(413 + 93*be)))*k1**2)*
              k2**8 - 14*(3*b1EFT*be*(11550 + 770*(19 + 36*b1EFT)*be + 1980*(2 + 17*b1EFT)*be**2 + 11*(11 + 920*b1EFT)*be**3 + 
                   665*b1EFT*be**4) - 110*b3EFT*(-315 + be*(-315 - 70*be + 6*be**2)))*k1**4*k2**10 - 
             35*be**2*(924*(3*b1EFT + b3EFT) + 396*(9*b1EFT*(1 + b1EFT) + b3EFT)*be + 11*b1EFT*(83 + 504*b1EFT)*be**2 + 1560*b1EFT**2*be**3)*
             k1**2*k2**12 - 210*b1EFT*be**4*(11 + 15*b1EFT*be)*k2**14) + 
     -     105*(k1 - k2)**3*(k1 + k2)**3*(11*b1EFT*be**4*k1**10 + 
            2*be**2*(-22*b3EFT*(7 + 3*be) + 33*b1EFT*(28 + 3*be*(6 + be)) + 3*b1EFT**2*be*(198 + be*(132 + 25*be)))*k1**8*k2**2 + 
             2*(-66*b3EFT*(35 + be*(35 + 2*be*(7 + be))) + 6*b1EFT**2*be*(1155 + 2*be*(924 + be*(693 + 286*be + 50*be**2))) + 
                11*b1EFT*(945 + 2*be*(525 + be*(315 + be*(108 + 17*be)))))*k1**6*k2**4 + 
             4*(33*b3EFT*(35 + be*(35 + 2*be*(7 + be))) + 
                b1EFT*be*(1155 + be*(2079 + 22*be*(54 + 11*be) + 6*b1EFT*(462 + be*(693 + be*(374 + 75*be))))))*k1**4*k2**6 + 
             be**2*(44*b3EFT*(7 + 3*be) + 33*b1EFT*(2 + be)*(14 + 11*be) + 12*b1EFT**2*be*(99 + 2*be*(77 + 25*be)))*k1**2*k2**8 + 
             2*b1EFT*be**4*(11 + 15*b1EFT*be)*k2**10)*(np.log((k1 - k2)**2) - 2*np.log(k1 + k2)))/(4.07484e7*b1EFT**3*k1**9*k2**7))
        else:
            return((-2*(3675*(3958*a7 + 81*b1EFT - 274*b3EFT + 126*b5EFT) + 14545650*a7*be + 330750*b1EFT*be + 161700*b1EFT**2*be - 
           154350*b1EFT*b2EFT*be - 1006950*b3EFT*be - 154350*b1EFT*b4EFT*be + 463050*b5EFT*be + 6321294*a7*be**2 + 186396*b1EFT*be**2 + 
           283710*b1EFT**2*be**2 + 51450*b1EFT**3*be**2 - 195510*b1EFT*b2EFT*be**2 - 438746*b3EFT*be**2 - 195510*b1EFT*b4EFT*be**2 + 
           195510*b5EFT*be**2 + 1046766*a7*be**3 + 51786*b1EFT*be**3 + 210798*b1EFT**2*be**3 + 123480*b1EFT**3*be**3 - 
           92610*b1EFT*b2EFT*be**3 - 72954*b3EFT*be**3 - 92610*b1EFT*b4EFT*be**3 + 30870*b5EFT*be**3 + 5697*b1EFT*be**4 + 
          77490*b1EFT**2*be**4 + 118188*b1EFT**3*be**4 - 18522*b1EFT*b2EFT*be**4 - 18522*b1EFT*b4EFT*be**4 + 11070*b1EFT**2*be**5 + 
           52920*b1EFT**3*be**5 + 9450*b1EFT**3*be**6 + 252*a2*(2975 + be*(2975 + be*(1281 + 209*be))) - 
           84*a5*(28875 + be*(28875 + be*(12341 + 1989*be))) + 56*a7*(5145 + be*(5145 + be*(3031 + 711*be)))*k2**2))/(231525.*b1EFT**3))
                    
    if(l1==0 and l2==2):
        if(k1!=k2):
            return(-(be*(4*k1*k2*(105*be**2*(-143*b3EFT + b1EFT*(858 + be*(221 + 45*b1EFT*(13 + 3*be))))*k1**14 + 
               35*(-143*b3EFT*(126 + be*(120 + 19*be)) + 13*b1EFT*(6237 + be*(7029 + be*(2442 + 377*be))) + 
                  9*b1EFT**2*be*(7722 + be*(11154 + be*(4979 + 905*be))))*k1**12*k2**2 + 
               7*(143*b3EFT*(1050 + be*(1240 + 207*be)) + 39*b1EFT*(-2310 + be*(-3520 + 3*be*(572 + 179*be))) + 
                  15*b1EFT**2*(72072 + be*(95238 + be*(52338 + be*(23829 + 4547*be)))))*k1**10*k2**4 + 
               13*k1**8*(-6468*(4656*a5 - 30056*a7 + 2125*b3EFT + 2*b1EFT*(-283 - 300*b1EFT + 420*b2EFT + 420*b4EFT) - 840*b5EFT) + 
                  6336*a2*(1519 + be*(1050 + 307*be)) + be*
                   (462*(295200*a7 - 20960*b3EFT + b1EFT*(5654 + 12661*b1EFT - 17920*b2EFT - 17920*b4EFT) + 7840*b5EFT) - 
                     2112*a5*(9730 + 2871*be) + be*(39461664*a7 - 2792141*b3EFT + 1086624*b5EFT - 
                        b1EFT*(-604725 + 4191264*b4EFT + 41290*be + 465696*(9*b2EFT + 2*(b2EFT + b4EFT)*be) + 
                           3*b1EFT*(-897666 + be*(-119197 + 30145*be))))) + 29568*a7*(245 + be*(210 + 53*be))*k1**2)*k2**6 + 
               k1**6*(96096*b1EFT**3*be*(1 + be)*(7 + 5*be)*(35 + 3*be*(14 + 5*be)) + 
                 13*b1EFT*(3101406 + be*(3883110 + be*(1831104 + 346949*be))) + 
                  3*b1EFT**2*(5325320 + be*(23621598 + be*(30019990 + be*(15187159 + 2925165*be)))) + 
                  143*(b3EFT*(6468 + 1049*be**2) + 3584*a7*(63 + be*(53 + 14*be))*k1**2))*k2**8 - 
              7*(-143*b3EFT*(1050 + be*(1240 + 207*be)) + 39*b1EFT*(19635 + be*(18535 + (2178 - 301*be)*be)) + 
                  15*b1EFT**2*be*(66924 + be*(77220 + be*(17875 + 53*be))))*k1**4*k2**10 - 
               35*(143*b3EFT*(126 + be*(120 + 19*be)) + b1EFT*be*(28314 + be*(35178 + 7813*be + 3*b1EFT*(15444 + be*(18603 + 4585*be)))))*
                k1**2*k2**12 - 105*be**2*(143*b3EFT + b1EFT*(429 + be*(442 + 15*b1EFT*(39 + 41*be))))*k2**14) + 
            105*(k1 - k2)**3*(k1 + k2)**3*(be**2*(-143*b3EFT + b1EFT*(858 + be*(221 + 45*b1EFT*(13 + 3*be))))*k1**10 + 
               (-143*b3EFT*(42 + be*(40 + 9*be)) + 39*b1EFT*(693 + be*(781 + 330*be + 57*be**2)) + 
                  3*b1EFT**2*be*(7722 + be*(11154 + be*(5499 + 1025*be))))*k1**8*k2**2 + 
               2*(-143*b3EFT*(21 + 4*be*(3 + be)) + 13*b1EFT*(2541 + be*(2772 + be*(1419 + 263*be))) + 
                  b1EFT**2*(36036 + 3*be*(26169 + be*(23595 + be*(11089 + 2075*be)))))*k1**6*k2**4 + 
               (286*b3EFT*(21 + 4*be*(3 + be)) + 13*b1EFT*(3927 + be*(5643 + be*(3003 + 641*be))) + 
                  12*b1EFT**2*be*(5577 + be*(9867 + be*(5863 + 1275*be))))*k1**4*k2**6 + 
               (3*b1EFT*be*(3146 + 858*(5 + 6*b1EFT)*be + 13*(97 + 517*b1EFT)*be**2 + 2075*b1EFT*be**3) + 143*b3EFT*(42 + be*(40 + 9*be)))*
               k1**2*k2**8 + be**2*(143*b3EFT + b1EFT*(429 + be*(442 + 15*b1EFT*(39 + 41*be))))*k2**10)*(np.log((k1 - k2)**2) - 2*np.log(k1 + k2)))
          )/(1.0594584e8*b1EFT**3*k1**9*k2**7))
        else:
            return((-8*be*(147*(3757*a7 + 110*b1EFT**2 - 263*b3EFT - 21*b1EFT*(-6 + 5*b2EFT + 5*b4EFT) + 105*b5EFT) + 18*a2*(1519 + be*(1050 + 307*be)) - 
           6*a5*(14259 + be*(9730 + 2871*be)) + be*(-27230*b3EFT + 10290*b5EFT - 7857*b3EFT*be + 3087*b5EFT*be + 3*a7*(129150 + 37369*be) + 
              21*b1EFT**3*(1 + be)*(7 + 5*be)*(35 + 3*be*(14 + 5*be)) + 
              3*b1EFT*(5873 + 3*be*(764 + 99*be) - 49*b2EFT*(160 + 9*be*(9 + 2*be)) - 49*b4EFT*(160 + 9*be*(9 + 2*be))) + 
              3*b1EFT**2*(11095 + be*(9058 + 15*be*(245 + 38*be)))) + 28*a7*(987 + be*(842 + 215*be))*k2**2))/(46305.*b1EFT**3))
    
    if(l1==2 and l2==2):
        if(k1!=k2):
            return(-(4*k1*k2*(14175*b1EFT*be**4*k1**18 + 210*be**2*(-52*b3EFT*(33 + 17*be) + 9*b1EFT**2*be*(780 + be*(590 + 117*be)) + 
                2*b1EFT*(5148 + be*(3978 + 679*be)))*k1**16*k2**2 + 
             70*(-26*b3EFT*(2079 + be*(3267 + be*(1419 + 151*be))) + 18*b1EFT**2*be*(11583 + be*(24453 + be*(19539 + be*(8326 + 1531*be)))) + 
                b1EFT*(243243 + 2*be*(212355 + be*(133848 + be*(41535 + 6943*be)))))*k1**14*k2**4 + 
            2*(182*b3EFT*(31185 + be*(49005 + be*(22297 + 3213*be))) + 
                39*b1EFT*(-436590 + be*(-686070 + be*(-284746 + 3*be*(-9562 + 689*be)))) + 
                42*b1EFT**2*be*(-321750 + be*(-353925 + be*(-31785 + 4*be*(13305 + 4286*be)))))*k1**12*k2**6 + 
            4*k1**10*(42042*(11008*a7 + 528*b1EFT - 845*b3EFT) - 219648*a5*(147 + be*(231 + 2*be*(521 + 209*be))) + 
                109824*a2*(147 + be*(231 + be*(699 + 271*be))) + 
                be*(6006*(b1EFT*(5489 + 894*b1EFT) - 9295*b3EFT) + 36608*a7*(19866 + be*(44679 + 16691*be)) + 
                   be*(b1EFT*(35931324 + 5*(2025660 - 133207*be)*be - 768768*b2EFT*(7 + 3*be)*(7 + 6*be) - 
                        768768*b4EFT*(7 + 3*be)*(7 + 6*be)) - 156*(-34496*b5EFT*(7 + 3*be) + b3EFT*(751773 + 277867*be)) + 
                      b1EFT**2*(34120086 + 3*be*(11569272 + (2110349 - 463655*be)*be)))) + 
                128128*a7*(735 + be*(1155 + be*(849 + 221*be)))*k1**2)*k2**8 + 
             2*k1**8*(768768*b1EFT**3*be**2*(1 + be)**2*(7 + 5*be)**2 + 
                6*b1EFT**2*be*(9971962 + be*(27333306 + be*(31994248 + be*(17984861 + 3763132*be)))) + 
               b1EFT*(45279234 + be*(84696612 + be*(95141904 + be*(53874600 + 11332691*be)))) + 
                52*(3*b3EFT*(-41503 + be*(-65219 + 2*be*(-9053 + 213*be))) + 448*a7*(2541 + be*(3993 + be*(3179 + 879*be)))*k1**2))*k2**10 + 
             2*(-2837835*(3*b1EFT - 2*b3EFT) - 810810*(b1EFT*(11 + 13*b1EFT) - 11*b3EFT)*be - 
                2002*(534*b1EFT + 4725*b1EFT**2 - 2027*b3EFT)*be**2 + 1638*(b1EFT*(683 + 815*b1EFT) + 357*b3EFT)*be**3 + 
                6*b1EFT*(87719 + 451640*b1EFT)*be**4 + 1004514*b1EFT**2*be**5)*k1**6*k2**12 - 
             14*(130*b3EFT*(2079 + be*(3267 + be*(1419 + 151*be))) + 
                b1EFT*be*(424710 + be*(785070 + 25*be*(16614 + 3353*be) + 6*b1EFT*(173745 + be*(293085 + 2*be*(76605 + 14966*be))))))*k1**4*
             k2**14 - 105*be**2*(104*b3EFT*(33 + 17*be) + 12*b1EFT**2*be*(1170 + be*(2115 + 719*be)) + b1EFT*(10296 + be*(15912 + 5027*be)))*
              k1**2*k2**16 - 5670*b1EFT*be**4*(5 + 7*b1EFT*be)*k2**18) + 
         105*(k1 - k2)**3*(k1 + k2)**3*(135*b1EFT*be**4*k1**14 + 
             2*be**2*(-52*b3EFT*(33 + 17*be) + 9*b1EFT**2*be*(780 + be*(590 + 117*be)) + 2*b1EFT*(5148 + be*(3978 + 769*be)))*k1**12*k2**2 + 
             (-52*b3EFT*(693 + be*(1089 + be*(649 + 141*be))) + 3*b1EFT*(54054 + be*(94380 + be*(77792 + 32604*be + 5721*be**2))) + 
                12*b1EFT**2*be*(11583 + be*(24453 + be*(22659 + be*(10686 + 1999*be)))))*k1**10*k2**4 + 
             2*(6006*(9*b1EFT + b3EFT) + 9438*(b1EFT*(13 + 6*b1EFT) + b3EFT)*be + 2574*(b1EFT*(71 + 97*b1EFT) - b3EFT)*be**2 + 
               78*(3*b1EFT*(437 + 1429*b1EFT) - 29*b3EFT)*be**3 + b1EFT*(20299 + 180582*b1EFT)*be**4 + 36525*b1EFT**2*be**5)*k1**8*k2**6 + 
             (156*b3EFT*(-77 + be*(-121 + be*(33 + 29*be))) + 12*b1EFT**2*be*(16731 + be*(45903 + be*(55731 + be*(33323 + 7500*be)))) + 
                b1EFT*(162162 + be*(320892 + be*(350064 + be*(204516 + 46543*be)))))*k1**6*k2**8 + 
             2*(3*b1EFT*be*(9438 + 286*(77 + 81*b1EFT)*be + 78*(209 + 581*b1EFT)*be**2 + (4318 + 31708*b1EFT)*be**3 + 8135*b1EFT*be**4) + 
                26*b3EFT*(693 + be*(1089 + be*(649 + 141*be))))*k1**4*k2**10 + 
            be**2*(104*b3EFT*(33 + 17*be) + 12*b1EFT**2*be*(1170 + be*(2115 + 803*be)) + b1EFT*(10296 + be*(15912 + 5747*be)))*k1**2*
              k2**12 + 54*b1EFT*be**4*(5 + 7*b1EFT*be)*k2**14)*(np.log((k1 - k2)**2) - 2*np.log(k1 + k2)))/(1.69513344e8*b1EFT**3*k1**11*k2**9))
        else:
            return((-8*(1617*(344*a7 + 27*b1EFT - 26*b3EFT) + 874104*a7*be + 76230*b1EFT*be + 32340*b1EFT**2*be - 66066*b3EFT*be + 1965876*a7*be**2 + 
           95700*b1EFT*be**2 + 129822*b1EFT**2*be**2 + 22638*b1EFT**3*be**2 - 45276*b1EFT*b2EFT*be**2 - 139546*b3EFT*be**2 - 
           45276*b1EFT*b4EFT*be**2 + 45276*b5EFT*be**2 + 734404*a7*be**3 + 44550*b1EFT*be**3 + 157080*b1EFT**2*be**3 + 77616*b1EFT**3*be**3 - 
           58212*b1EFT*b2EFT*be**3 - 51634*b3EFT*be**3 - 58212*b1EFT*b4EFT*be**3 + 19404*b5EFT*be**3 + 6237*b1EFT*be**4 + 
          74250*b1EFT**2*be**4 + 98868*b1EFT**3*be**4 - 16632*b1EFT*b2EFT*be**4 - 16632*b1EFT*b4EFT*be**4 + 12540*b1EFT**2*be**5 + 
           55440*b1EFT**3*be**5 + 11550*b1EFT**3*be**6 - 264*a5*(147 + be*(231 + 2*be*(521 + 209*be))) + 
           132*a2*(147 + be*(231 + be*(699 + 271*be))) + 28*a7*(5313 + be*(8349 + be*(6259 + 1655*be)))*k2**2))/(101871.*b1EFT**3))
